...
@implementation CustomSliderControl{
    //will be used to render the various components of your slider control
    SliderTrackColor* _trackLayer;
    KnobLayer* _upperKnobLayer;
    KnobLayer* _lowerKnobLayer;
...
- (id)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        _trackLayer = [SliderTrackColor layer];
        _trackLayer.slider = self;
        [self.layer addSublayer:_trackLayer];
        
        _upperKnobLayer = [KnobLayer layer];
        _upperKnobLayer.slider = self;
        [self.layer addSublayer:_upperKnobLayer];
        
        _lowerKnobLayer = [KnobLayer layer];
